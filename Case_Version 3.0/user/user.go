...
func UsersEntry(w http.ResponseWriter, r *http.Request) {
	...
	for rows.Next() {
		rows.Scan(&userEntry.Entry.Id, &userEntry.Entry.Entry_Code, &userEntry.Entry.Entry_Title, &userEntry.Entry.Create_Date, &userEntry.Entry.Update_Date, &userEntry.Entry.Status, &userEntry.Entry.Assig, &userEntry.Entry.Tag, &userEntry.Entry.Is_Active)
